...
public class GameResult {
    ...
    public void save(Boolean isWin) {
    ...
    public void getGames(Handler<Result> handler) {
        ...
        Task<Result> task = new Task<Result>() {
            ...
            protected Result call() throws Exception {
                ...
                result.setWinnings((Long) em.createQuery("select count (g) from Game g where g.win = true").getSingleResult());
